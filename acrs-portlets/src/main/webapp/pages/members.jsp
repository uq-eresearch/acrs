	...
	else
	{
		...
		<p>Please do not use this form yet. It is still under development.</p>
			...
			<% 
				...
				String paypalItemName = (String) renderRequest.getAttribute("paypalItemName");
			%>
...
<!-- 
 ...
 -->
				...
				<input type="hidden" name="return" value="http://localhost:8080/web/guest">
				<input type="hidden" name="cancel_return" value="http://localhost:8080/web/guest">
