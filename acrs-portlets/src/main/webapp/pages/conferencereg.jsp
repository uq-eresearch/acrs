...
<% 
	...
	ConferenceRegistration newMember = (ConferenceRegistration) renderRequest.getPortletSession().getAttribute("newMember", PortletSession.APPLICATION_SCOPE);

	ConferenceRegistrationDao membersDao = (ConferenceRegistrationDao) renderRequest.getAttribute("membersDao");
	ConferenceRegistration editMember = (ConferenceRegistration) membersDao.getById(memberId);
	...
	{
		List<ConferenceRegistration> membersList = (List<ConferenceRegistration>) renderRequest.getAttribute("allMembers");
	...
	%>
		...
		<fieldset>
		<legend>Conference Registration</legend>
		...
		<% for (ConferenceRegistration member : membersList) { 
